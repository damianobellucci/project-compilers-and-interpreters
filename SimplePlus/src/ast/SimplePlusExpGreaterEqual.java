...
public class SimplePlusExpGreaterEqual extends SimplePlusExp {
	
	SimplePlusExp leftSide, rightSide;

	public SimplePlusExpGreaterEqual(SimplePlusExp leftSide, SimplePlusExp rightSide) {

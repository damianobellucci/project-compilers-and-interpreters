...
public class SimplePlusExpCall extends SimplePlusExp {
	String id;
	List<SimplePlusExp> args;

	private SymbolTable symbolTable;

	public SimplePlusExpCall(String id, List<SimplePlusExp> args) {
		this.id = id;
		this.args = args;
	}
	...
	public List<SemanticError> checkSemantics(Environment e) {
		...
		if (!e.containsVariable(id)) {
			...
			if (e.functionsArgs.get(id).size()!=args.size()) {
	...
	public SymbolTable symbolTableGeneration(SymbolTable symbolTable) {
		...
		// System.out.println("call exp " + symbolTable.toString());

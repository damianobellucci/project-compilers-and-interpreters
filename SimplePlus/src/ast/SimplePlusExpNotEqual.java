...
public class SimplePlusExpNotEqual extends SimplePlusExp {

	SimplePlusExp leftSide, rightSide;

	public SimplePlusExpNotEqual(SimplePlusExp leftSide, SimplePlusExp rightSide) {

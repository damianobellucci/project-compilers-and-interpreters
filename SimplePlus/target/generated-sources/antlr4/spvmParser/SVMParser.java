...
public class SVMParser extends Parser {
	...
	public static final int
		...
		T__3=32, T__2=33, T__1=34, T__0=35, LABEL=36, NUMBER=37, REGISTER=38, 
	...
	public static final String[] tokenNames = {
		...
		"'or'", "'halt'", "'jr'", "'smem'", "'div'", "'pop'", "'gr'", "')'", "'and'", 
		"'not'", "'top'", "LABEL", "NUMBER", "REGISTER", "WS", "LINECOMMENTS", 
		"BLOCKCOMMENTS"
	};
	public static final int
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__34) | (1L << T__33) | (1L << T__32) | (1L << T__31) | (1L << T__30) | (1L << T__29) | (1L << T__28) | (1L << T__27) | (1L << T__26) | (1L << T__25) | (1L << T__24) | (1L << T__23) | (1L << T__22) | (1L << T__21) | (1L << T__20) | (1L << T__18) | (1L << T__17) | (1L << T__15) | (1L << T__14) | (1L << T__13) | (1L << T__12) | (1L << T__11) | (1L << T__10) | (1L << T__9) | (1L << T__8) | (1L << T__7) | (1L << T__6) | (1L << T__5) | (1L << T__4) | (1L << T__2) | (1L << T__1) | (1L << T__0) | (1L << LABEL))) != 0)) {
				{
				{
				setState(4); assembly();
				}
	...
	public final AssemblyContext assembly() throws RecognitionException {
		...
		try {
			...
			case T__24:
				enterOuterAlt(_localctx, 1);
				{
				setState(10); ((AssemblyContext)_localctx).instr = match(T__24);
			...
			case T__18:
				...
				{
				setState(15); ((AssemblyContext)_localctx).instr = match(T__18);
			...
			case T__17:
				...
				{
				setState(19); ((AssemblyContext)_localctx).instr = match(T__17);
			...
			case T__34:
				...
				{
				setState(23); ((AssemblyContext)_localctx).instr = match(T__34);
			...
			case T__22:
				...
				{
				setState(31); ((AssemblyContext)_localctx).instr = match(T__22);
			...
			case T__10:
				...
				{
				setState(38); ((AssemblyContext)_localctx).instr = match(T__10);
			...
			case T__23:
				...
				{
				setState(45); ((AssemblyContext)_localctx).instr = match(T__23);
			...
			case T__29:
				...
				{
				setState(49); ((AssemblyContext)_localctx).instr = match(T__29);
			...
			case T__11:
				...
				{
				setState(53); ((AssemblyContext)_localctx).instr = match(T__11);
			...
			case T__31:
				...
				{
				setState(57); ((AssemblyContext)_localctx).instr = match(T__31);
			...
			case T__26:
				...
				{
				setState(65); ((AssemblyContext)_localctx).instr = match(T__26);
			...
			case T__33:
				...
				{
				setState(69); ((AssemblyContext)_localctx).instr = match(T__33);
			...
			case T__20:
				...
				{
				setState(75); ((AssemblyContext)_localctx).instr = match(T__20);
			...
			case T__7:
				...
				{
				setState(81); ((AssemblyContext)_localctx).instr = match(T__7);
			...
			case T__21:
				...
				{
				setState(87); ((AssemblyContext)_localctx).instr = match(T__21);
				setState(88); ((AssemblyContext)_localctx).arg1 = match(REGISTER);
				setState(89); ((AssemblyContext)_localctx).offset = match(NUMBER);
				setState(90); match(T__19);
				setState(91); ((AssemblyContext)_localctx).arg2 = match(REGISTER);
			...
			case LABEL:
				...
				{
				setState(93); ((AssemblyContext)_localctx).instr = match(LABEL);
			...
			case T__28:
				...
				{
				setState(95); ((AssemblyContext)_localctx).instr = match(T__28);
				setState(96); ((AssemblyContext)_localctx).arg3 = match(LABEL);
				}
				break;
			case T__15:
				enterOuterAlt(_localctx, 24);
				{
				setState(97); ((AssemblyContext)_localctx).instr = match(T__15);
				setState(98); ((AssemblyContext)_localctx).arg1 = match(REGISTER);
				setState(99); ((AssemblyContext)_localctx).arg2 = match(REGISTER);
				setState(100); ((AssemblyContext)_localctx).arg3 = match(LABEL);
				}
				break;
			case T__12:
				enterOuterAlt(_localctx, 25);
				{
				setState(101); ((AssemblyContext)_localctx).instr = match(T__12);
				setState(102); ((AssemblyContext)_localctx).arg1 = match(REGISTER);
				setState(103); ((AssemblyContext)_localctx).arg2 = match(REGISTER);
				setState(104); ((AssemblyContext)_localctx).arg3 = match(LABEL);
				}
				break;
			case T__30:
				enterOuterAlt(_localctx, 26);
				{
				setState(105); ((AssemblyContext)_localctx).instr = match(T__30);
				setState(106); ((AssemblyContext)_localctx).arg1 = match(REGISTER);
				setState(107); ((AssemblyContext)_localctx).arg2 = match(REGISTER);
				setState(108); ((AssemblyContext)_localctx).arg3 = match(LABEL);
				}
				break;
			case T__27:
				enterOuterAlt(_localctx, 27);
				{
				setState(109); ((AssemblyContext)_localctx).instr = match(T__27);
				setState(110); ((AssemblyContext)_localctx).arg1 = match(REGISTER);
				setState(111); ((AssemblyContext)_localctx).arg2 = match(REGISTER);
				setState(112); ((AssemblyContext)_localctx).arg3 = match(NUMBER);
				}
				break;
			case T__14:
				enterOuterAlt(_localctx, 28);
				{
				setState(113); ((AssemblyContext)_localctx).instr = match(T__14);
				setState(114); ((AssemblyContext)_localctx).arg1 = match(REGISTER);
				setState(115); ((AssemblyContext)_localctx).arg2 = match(NUMBER);
				}
				break;
			case T__32:
				enterOuterAlt(_localctx, 29);
				{
				setState(116); ((AssemblyContext)_localctx).instr = match(T__32);
				setState(117); ((AssemblyContext)_localctx).arg1 = match(REGISTER);
				setState(118); ((AssemblyContext)_localctx).arg2 = match(REGISTER);
				}
				break;
			case T__13:
				enterOuterAlt(_localctx, 30);
				{
				setState(119); ((AssemblyContext)_localctx).instr = match(T__13);
				setState(120); ((AssemblyContext)_localctx).arg3 = match(LABEL);
				}
				break;
			case T__8:
				enterOuterAlt(_localctx, 31);
				{
				setState(121); ((AssemblyContext)_localctx).instr = match(T__8);
				setState(122); ((AssemblyContext)_localctx).arg1 = match(REGISTER);
				}
				break;
			case T__25:
				enterOuterAlt(_localctx, 32);
				{
				setState(123); ((AssemblyContext)_localctx).instr = match(T__25);
				setState(124); ((AssemblyContext)_localctx).arg1 = match(REGISTER);
				}
				break;
			case T__9:
				enterOuterAlt(_localctx, 33);
				{
				setState(125); ((AssemblyContext)_localctx).instr = match(T__9);
				}
				break;
			default:
	...
	public static final String _serializedATN =
		...
		"\n\3\3\2\2\2\13\t\3\2\2\2\f\r\7\r\2\2\r\u0081\7(\2\2\16\u0081\7 \2\2\17"+
		"\20\7%\2\2\20\u0081\7(\2\2\21\22\7\23\2\2\22\23\7(\2\2\23\24\7(\2\2\24"+
		"\u0081\7(\2\2\25\26\7\24\2\2\26\27\7(\2\2\27\30\7(\2\2\30\u0081\7(\2\2"+
		"\31\32\7\3\2\2\32\33\7(\2\2\33\34\7(\2\2\34\u0081\7(\2\2\35\36\7\37\2"+
		"\2\36\37\7(\2\2\37 \7(\2\2 \u0081\7(\2\2!\"\7\17\2\2\"#\7(\2\2#\u0081"+
		"\7(\2\2$%\7#\2\2%&\7(\2\2&\'\7(\2\2\'\u0081\7(\2\2()\7\33\2\2)*\7(\2\2"+
		"*+\7(\2\2+\u0081\7(\2\2,-\7$\2\2-.\7(\2\2.\u0081\7(\2\2/\60\7\16\2\2\60"+
		"\61\7(\2\2\61\62\7(\2\2\62\u0081\7(\2\2\63\64\7\b\2\2\64\65\7(\2\2\65"+
		"\66\7(\2\2\66\u0081\7(\2\2\678\7\32\2\289\7(\2\29:\7(\2\2:\u0081\7(\2"+
		"\2;<\7\6\2\2<=\7(\2\2=>\7(\2\2>\u0081\7(\2\2?@\7!\2\2@A\7(\2\2AB\7(\2"+
		"\2B\u0081\7(\2\2CD\7\13\2\2DE\7(\2\2EF\7(\2\2F\u0081\7(\2\2GH\7\4\2\2"+
		"HI\7(\2\2IJ\7\'\2\2JK\7\22\2\2KL\7(\2\2L\u0081\7\"\2\2MN\7\21\2\2NO\7"+
		"(\2\2OP\7\'\2\2PQ\7\22\2\2QR\7(\2\2R\u0081\7\"\2\2ST\7\36\2\2TU\7(\2\2"+
		"UV\7\'\2\2VW\7\22\2\2WX\7(\2\2X\u0081\7\"\2\2YZ\7\20\2\2Z[\7(\2\2[\\\7"+
		"\'\2\2\\]\7\22\2\2]^\7(\2\2^\u0081\7\"\2\2_`\7&\2\2`\u0081\7\25\2\2ab"+
		"\7\t\2\2b\u0081\7&\2\2cd\7\26\2\2de\7(\2\2ef\7(\2\2f\u0081\7&\2\2gh\7"+
		"\31\2\2hi\7(\2\2ij\7(\2\2j\u0081\7&\2\2kl\7\7\2\2lm\7(\2\2mn\7(\2\2n\u0081"+
		"\7&\2\2op\7\n\2\2pq\7(\2\2qr\7(\2\2r\u0081\7\'\2\2st\7\27\2\2tu\7(\2\2"+
		"u\u0081\7\'\2\2vw\7\5\2\2wx\7(\2\2x\u0081\7(\2\2yz\7\30\2\2z\u0081\7&"+
		"\2\2{|\7\35\2\2|\u0081\7(\2\2}~\7\f\2\2~\u0081\7(\2\2\177\u0081\7\34\2"+
		"\2\u0080\f\3\2\2\2\u0080\16\3\2\2\2\u0080\17\3\2\2\2\u0080\21\3\2\2\2"+
		"\u0080\25\3\2\2\2\u0080\31\3\2\2\2\u0080\35\3\2\2\2\u0080!\3\2\2\2\u0080"+
		"$\3\2\2\2\u0080(\3\2\2\2\u0080,\3\2\2\2\u0080/\3\2\2\2\u0080\63\3\2\2"+
		"\2\u0080\67\3\2\2\2\u0080;\3\2\2\2\u0080?\3\2\2\2\u0080C\3\2\2\2\u0080"+
		"G\3\2\2\2\u0080M\3\2\2\2\u0080S\3\2\2\2\u0080Y\3\2\2\2\u0080_\3\2\2\2"+
		"\u0080a\3\2\2\2\u0080c\3\2\2\2\u0080g\3\2\2\2\u0080k\3\2\2\2\u0080o\3"+
